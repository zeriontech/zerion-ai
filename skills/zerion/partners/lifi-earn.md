...
- **capabilities/analyze.md** — full portfolio + positions snapshot, useful for post-deposit verification
- **capabilities/wallet.md** — wallet management primitives that precede every flow
