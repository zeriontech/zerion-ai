...
| Move money once a validated idea ships | `capabilities/trading.md` skill (`swap`, `bridge`, `send`) |
| Build an autonomous-trading bot from a validated DeFi thesis | `capabilities/agent-management.md` (agent tokens + policies) |
