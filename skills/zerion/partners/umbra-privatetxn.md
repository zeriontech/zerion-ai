...
1. **Wallet provisioning** (`capabilities/wallet.md`)
...
2. **Portfolio inspection before depositing** (`capabilities/analyze.md`)
...
3. **Token acquisition** (`capabilities/trading.md`)
...
4. **Master-seed derivation** (`capabilities/sign.md`)
...
5. **Autonomous claim retry** (`capabilities/agent-management.md`)
...
6. **History view** (`capabilities/analyze.md` + Umbra data-indexer)
...
Routing: `capabilities/trading.md` (swap) → `capabilities/wallet.md` (signer hand-off) →
this skill's deposit + create flows → `capabilities/sign.md` (any extra signature
prompts).
